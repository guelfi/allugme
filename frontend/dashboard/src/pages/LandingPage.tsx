...
function ThemeCarousel({
  ...
  return (
    <div className="lp-carousel" aria-roledescription="carrossel">
      <div className="lp-carousel-toolbar">
        <p className="lp-carousel-hint">
          Carrossel automático — use as setas para inverter a direção
        </p>
        <div className="lp-carousel-controls">
          <button
            type="button"
            className={`lp-carousel-arrow${direction === 'forward' ? ' is-active' : ''}`}
          ...
          <button
            type="button"
            className={`lp-carousel-arrow${direction === 'reverse' ? ' is-active' : ''}`}
  ...
  return (
    <div className="lp">
      ...
      <main id="topo">
        ...
        <section className="lp-viewport lp-cta-band">
          <div className="lp-section-inner">
