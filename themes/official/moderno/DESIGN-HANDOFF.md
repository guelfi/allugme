# 73484e9e-c138-406b-80db-076c876b6418 implementation handoff
...
- `assets/img/cidade.jpg`
- `assets/img/galeria-2.jpg`
- `assets/img/hero.jpg`
- `assets/img/imovel-1.jpg`
- `assets/img/imovel-2.jpg`
- `assets/img/imovel-3.jpg`
- `assets/img/imovel-4.jpg`
- `assets/img/imovel-5.jpg`
- `assets/img/imovel-6.jpg`
- `README.md`
- `theme.json`
