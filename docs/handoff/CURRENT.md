...
4. Handoff LP layout: [lp-layout-secoes.md](lp-layout-secoes.md) — implementado e em produção (`132d730`)
...
| Handoff LP layout seções | ✅ [lp-layout-secoes.md](lp-layout-secoes.md) — implementado em prod |
