...
## 7. URLs de vitrine (dev)

Padrão path (MVP):

```
/t/horizon/          → tema moderno
/t/vista-urbana/     → tema urbano
/t/casa-tradicao/    → tema classico
/t/atlas/            → tema minimal
/t/porto-lar/        → tema porto
```

Ou subdomínio: `{slug}.localhost:port`.
