...
## Arquivos comuns (pasta pai `docs/`)

Se receberem junto com este pacote:

| Arquivo | Uso |
|---------|-----|
| [`../glossario.md`](../glossario.md) | Termos comuns |
| [`../rbac-matriz.md`](../rbac-matriz.md) | Papéis e permissões |
| [`../escopo-mvp-rinha.md`](../escopo-mvp-rinha.md) | Escopo MVP para comparação justa |
...
4. Mantenha o **mesmo escopo MVP** descrito em `../escopo-mvp-rinha.md` para a comparação ser justa.  
...
Detalhes: [escopo-mvp-rinha.md](../escopo-mvp-rinha.md).
